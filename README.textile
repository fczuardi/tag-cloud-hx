...
TagCloud-hx is a package containing a set of haXe classes to help the 
creation of dynamic Tag Clouds based on frequency of keywords on a given 
data.
...
The Initial Developer of the Original Code is JWT Brasil, HSBC Brasil 
and HSBC México.
